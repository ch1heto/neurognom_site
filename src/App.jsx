...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background font-body text-on-background antialiased transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100">
